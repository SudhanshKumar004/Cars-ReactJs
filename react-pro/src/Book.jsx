...
const Book = () =>{
    ...
    return(
      ...
      <form onSubmit={finalsubmit}>
          ...
          <input type="date" name="deliveryDate" value={data.deliveryDate} onChange={hinput} required />
          ...
          <label htmlFor="country">Model:</label>
          <input type="text" name="model" value={data.model} onChange={hinput} required />
